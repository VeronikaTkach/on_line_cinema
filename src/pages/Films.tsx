...
const Films = () => {
  ...
  return (
    <div className="">
      ...
      <button className="btn-adaptive-white-counter mt-[50px]" onClick={showMoreFilms}>Все новинки</button>
    </div>
  );
};
